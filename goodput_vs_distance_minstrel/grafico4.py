...
csv=pd.read_csv('goodput_vs_distance_minstrel/goodput_vs_distance_802.11be_minstrel_maxWidthChannels_gi800.csv', sep=',')
...
plt.yticks(np.arange(0, dataframe['Mean_Goodput(Mbps)'].max() + 50, 25), fontsize=17)
