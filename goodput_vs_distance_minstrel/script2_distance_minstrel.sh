...
echo "Mean_Goodput(Mbps),Distance(m),FrequencyBand(GHz),ChannelWidth(MHz),SimulationTime(s),Seed" > goodput_vs_distance_802.11be_minstrel_maxWidthChannels_gi800_seed$seed.csv
