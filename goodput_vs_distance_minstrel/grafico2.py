...
csv_files = ['goodput_vs_distance_minstrel/802.11ax/goodput_vs_distance_802.11ax_minstrel_maxWidthChannels_gi800_seed1.csv',
             'goodput_vs_distance_minstrel/802.11ax/goodput_vs_distance_802.11ax_minstrel_maxWidthChannels_gi800_seed2.csv',
             'goodput_vs_distance_minstrel/802.11ax/goodput_vs_distance_802.11ax_minstrel_maxWidthChannels_gi800_seed3.csv',
             'goodput_vs_distance_minstrel/802.11ax/goodput_vs_distance_802.11ax_minstrel_maxWidthChannels_gi800_seed4.csv',
             'goodput_vs_distance_minstrel/802.11ax/goodput_vs_distance_802.11ax_minstrel_maxWidthChannels_gi800_seed5.csv',
             'goodput_vs_distance_minstrel/802.11ax/goodput_vs_distance_802.11ax_minstrel_maxWidthChannels_gi800_seed6.csv',
             'goodput_vs_distance_minstrel/802.11ax/goodput_vs_distance_802.11ax_minstrel_maxWidthChannels_gi800_seed7.csv',
             'goodput_vs_distance_minstrel/802.11ax/goodput_vs_distance_802.11ax_minstrel_maxWidthChannels_gi800_seed8.csv',
             'goodput_vs_distance_minstrel/802.11ax/goodput_vs_distance_802.11ax_minstrel_maxWidthChannels_gi800_seed9.csv',
             'goodput_vs_distance_minstrel/802.11ax/goodput_vs_distance_802.11ax_minstrel_maxWidthChannels_gi800_seed10.csv']
...
plt.yticks(np.arange(0, mean_df['Mean_Goodput(Mbps)'].max() + 50, 50), fontsize=21)
