...
csv=pd.read_csv('goodput_vs_distance/resultados_802.11be_5GHz_channelWidth160MHz_gi800.csv', sep=',')
...
plt.ylim(top=800+10)
plt.yticks(np.arange(filtered_dataframe['Mean_Throughput(Mbps)'].min(), 801, 50), fontsize=15)
