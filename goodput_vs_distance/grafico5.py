...
csv_files = ['goodput_vs_distance/802.11be/resultados_802.11be_5GHz_channelWidth160MHz_gi800_seed1.csv',
             'goodput_vs_distance/802.11be/resultados_802.11be_5GHz_channelWidth160MHz_gi800_seed2.csv',
             'goodput_vs_distance/802.11be/resultados_802.11be_5GHz_channelWidth160MHz_gi800_seed3.csv',
             'goodput_vs_distance/802.11be/resultados_802.11be_5GHz_channelWidth160MHz_gi800_seed4.csv',
             'goodput_vs_distance/802.11be/resultados_802.11be_5GHz_channelWidth160MHz_gi800_seed5.csv',
             'goodput_vs_distance/802.11be/resultados_802.11be_5GHz_channelWidth160MHz_gi800_seed6.csv',
             'goodput_vs_distance/802.11be/resultados_802.11be_5GHz_channelWidth160MHz_gi800_seed7.csv',
             'goodput_vs_distance/802.11be/resultados_802.11be_5GHz_channelWidth160MHz_gi800_seed8.csv',
             'goodput_vs_distance/802.11be/resultados_802.11be_5GHz_channelWidth160MHz_gi800_seed9.csv',
             'goodput_vs_distance/802.11be/resultados_802.11be_5GHz_channelWidth160MHz_gi800_seed10.csv']
...
#plt.title('Mean Goodput vs Distance - 802.11be (5GHz)')
