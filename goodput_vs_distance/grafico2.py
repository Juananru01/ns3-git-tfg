...
csv=pd.read_csv('goodput_vs_distance/resultados_802.11ax_v2_2.4GHz_channelWidth40MHz_gi800.csv', sep=',')
...
plt.ylim(top=275+5)
plt.xticks(np.arange(dataframe['Distance(m)'].min(), 101, 10), fontsize=13)
plt.yticks(np.arange(dataframe['Mean_Throughput(Mbps)'].min(), 276, 25), fontsize=13)
