...
csv=pd.read_csv('goodput_vs_mcs_802.11ax_5GHz_gi800.csv', sep=',')
...
plt.title('Mean Goodput vs MCS - 802.11ax (5GHz) - 800 GI')

plt.xticks(np.arange(0, dataframe['MCS'].max() + 1, 1))
plt.yticks(np.arange(0, dataframe['Mean_Goodput(Mbps)'].max() + 25, 50))
