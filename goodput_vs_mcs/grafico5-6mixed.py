...
csv_files = ['goodput_vs_mcs/goodput_vs_mcs_802.11be_2.4GHz_seed1.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_2.4GHz_seed2.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_2.4GHz_seed3.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_2.4GHz_seed4.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_2.4GHz_seed5.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_2.4GHz_seed6.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_2.4GHz_seed7.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_2.4GHz_seed8.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_2.4GHz_seed9.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_2.4GHz_seed10.csv']
...
plt.yticks(np.arange(0, 281, 20), fontsize=21)

plt.legend(title='Channel Width - GI', loc='upper left', title_fontsize=19, fontsize=18)
plt.grid(True)
