...
csv_files = ['goodput_vs_mcs/goodput_vs_mcs_802.11be_5GHz_seed1.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_5GHz_seed2.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_5GHz_seed3.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_5GHz_seed4.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_5GHz_seed5.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_5GHz_seed6.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_5GHz_seed7.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_5GHz_seed8.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_5GHz_seed9.csv',
             'goodput_vs_mcs/goodput_vs_mcs_802.11be_5GHz_seed10.csv']
...
#plt.title('Mean Goodput vs MCS - 802.11be (5GHz)')

plt.ylim(top=800+10)
plt.xticks(np.arange(0, mean_df['MCS'].max() + 1, 1), fontsize=21)
plt.yticks(np.arange(0, 801, 50), fontsize=21)

plt.legend(title='Channel Width - GI', loc='upper left', title_fontsize=16, fontsize=15.5)
plt.grid(True)
