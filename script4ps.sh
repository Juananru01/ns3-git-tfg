...
for payloadSize in {200..10000..200}; do
    ...
    output=$(../ns3 run "scratch/goodput_vs_payloadsize_802.11be_minstrel --payloadSize=$payloadSize --channelWidth=$maxChannelWidth --distance=3 --frequency=$frequencyBand --simulationTime=25 --guard_interval=800 --seed=$seed");
