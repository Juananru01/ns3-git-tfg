...
plt.ylim(top=600+5)
plt.xticks(np.arange(0, dataframe['PayloadSize(bytes)'].max() + 5, 1000), fontsize=17)
plt.yticks(np.arange(0, 601, 25), fontsize=17)

plt.legend(title='Frequency Band',loc='lower right', title_fontsize=16, fontsize=15)
plt.grid(True)
